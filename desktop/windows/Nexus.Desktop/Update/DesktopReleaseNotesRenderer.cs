...
internal static class DesktopReleaseNotesRenderer
{
    ...
    public static FlowDocument Render(string markdown)
    {
        ...
        var document = new FlowDocument
        {
            ...
            FontSize = 12,
            Foreground = NexusNativeTheme.TextDefaultBrush,
        };
        ...
        for (int index = 0; index < lines.Length;)
        {
            ...
            if (trimmed.StartsWith(">", StringComparison.Ordinal))
            {
                AddParagraph(
                    ...
                    trimmed[1..].Trim(),
                    prefix: "│ ",
                    foreground: NexusNativeTheme.TextMutedBrush,
        ...
        double paragraphSpacing = 8)
    {
        var paragraph = new Paragraph
        {
            ...
            Foreground = foreground ?? NexusNativeTheme.TextDefaultBrush,
    ...
    private static void AddCodeBlock(FlowDocument document, string text)
    {
        var paragraph = new Paragraph
        {
            ...
            FontSize = 11,
            Background = NexusNativeTheme.InteractiveHoverBrush,
    ...
    private static void AddInline(Paragraph paragraph, string text)
    {
        ...
        foreach (Match match in InlinePattern.Matches(text))
        {
            ...
            else if (TryParseLink(token, out string label, out Uri? uri))
            {
                ...
                {
                    NavigateUri = uri!,
                    Foreground = NexusNativeTheme.PrimaryBrush,
                };
