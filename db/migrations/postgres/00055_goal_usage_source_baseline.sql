...
CREATE TABLE IF NOT EXISTS goal_usage_source_evidence (
    ...
    baseline_unavailable BOOLEAN NOT NULL DEFAULT FALSE,
    PRIMARY KEY (
        owner_user_id,
        runtime_session_key,
        source_kind,
...
ALTER TABLE goal_usage_source_evidence
ADD COLUMN IF NOT EXISTS baseline_unavailable BOOLEAN NOT NULL DEFAULT FALSE;

CREATE INDEX IF NOT EXISTS idx_goal_usage_source_evidence_scope
...
ALTER TABLE goal_usage_source_evidence DROP COLUMN IF EXISTS baseline_unavailable;
