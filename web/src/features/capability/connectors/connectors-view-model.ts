...
export interface ConnectorDirectoryController {
  ...
  open_detail: (connectorId: string) => Promise<void>;
  close_detail: () => void;
  close_device_auth_session: () => void;
  handle_connect: (connectorId: string) => Promise<void>;
  handle_connect_with_credential: (connectorId: string, credential: string) => Promise<boolean>;
  handle_disconnect: (connectorId: string) => Promise<void>;
  handle_save_oauth_client: (connectorId: string, clientId: string, clientSecret: string) => Promise<boolean>;
  handle_delete_oauth_client: (connectorId: string) => Promise<boolean>;
  busy_id: string | null;
