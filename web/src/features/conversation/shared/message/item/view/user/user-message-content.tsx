...
export function UserMessageContent({
  ...
  return (
    <div className="nexus-chat-user-content-shell ml-auto flex w-fit max-w-full flex-col items-end rounded-[14px] bg-(--surface-message-user-background) px-3.5 py-2.5">
