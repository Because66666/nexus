...
export function GroupMemberAvatarStack({
  ...
  return (
    <button
      className="flex h-9 items-center gap-1 rounded-full border border-[color:color-mix(in_srgb,var(--divider-subtle-color)_82%,transparent)] bg-[color:color-mix(in_srgb,var(--background)_74%,var(--surface-panel-background)_26%)] px-2 text-[10.5px] font-medium text-(--text-default) transition-[border-color,background,color] duration-(--motion-duration-fast) hover:border-(--surface-interactive-hover-border) hover:bg-[color:color-mix(in_srgb,var(--surface-interactive-hover-background)_72%,var(--background)_28%)] hover:text-(--text-strong)"
