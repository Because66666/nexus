...
export const MARKDOWN_BODY_CLASS_NAME = "nexus-chat-markdown nexus-markdown-body message-cjk-font w-full min-w-0 max-w-full overflow-x-hidden text-[16px] leading-[1.65rem] text-(--text-strong) [&_strong]:font-bold [&_strong]:text-(--text-strong) [&_em]:italic";
