...
- `workspace-content-header.tsx` 是管理页正文标题、单句说明与页面动作的唯一 Header；在 macOS 统一标题栏中必须参与窗口手势，以共享顶部补偿让标题和动作对齐原生控件，并在侧栏折叠或无侧栏时通过共享横向安全区避开 traffic lights 与侧栏展开入口，不得给具体页面添加私有 padding。
