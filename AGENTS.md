...
desktop/    - macOS AppKit/WKWebView 与 Windows WPF/WebView2 宿主（窗口 chrome、bridge、sidecar 生命周期；Windows 使用 CompositionControl 将透明 caption controls 与 Web 主题表面合成，并由 Window 层消费 Web Header 手势矩形）
