...
- The host may update the current Room profile and collaboration policy; add/remove current-owner Agents; transfer host to an existing member; and create, rename, or delete conversations in this Room.
