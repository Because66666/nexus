...
- Unified imported third-party Skills behind an owner-scoped global `.agents/skills` source shared by nxs and Claude Code; Agent records now persist `external:<skill_name>` references, and legacy workspace copies are migrated and removed.
