...
- Fixed Safari occasionally leaving a faint switch-shaped rectangle in conversations by keeping its liquid-glass controls on the static material instead of mounting SVG backdrop filters that can leave stale compositing pixels after unmount, and removed Safari's native blue focus outline from the programmatically focusable message viewport.
