...
type roomCancellationProviderClient struct {
	mu             sync.Mutex
	interruptCalls int
	onInterrupt    func()
}

func (c *roomCancellationProviderClient) Connect(context.Context) error { return nil }

func (c *roomCancellationProviderClient) Query(context.Context, string) error { return nil }

func (c *roomCancellationProviderClient) ReceiveMessages(
	context.Context,
...
func (c *roomCancellationProviderClient) Interrupt(context.Context) error {
	c.mu.Lock()
	c.interruptCalls++
...
func (c *roomCancellationProviderClient) StopTask(context.Context, string) error {
	return nil
}

func (c *roomCancellationProviderClient) SendTaskMessage(
	context.Context,
	string,
	string,
	string,
...
func (c *roomCancellationProviderClient) RemoveMessages(
	context.Context,
	[]string,
) error {
	return nil
...
func (c *roomCancellationProviderClient) SetPermissionMode(
	context.Context,
	sdkpermission.Mode,
) error {
	return nil
...
func (c *roomCancellationProviderClient) Reconfigure(
	context.Context,
	agentclient.Options,
) error {
	return nil
...
func (c *roomCancellationProviderClient) SessionID() string {
	return "room-cancellation-provider-session"
}

type roomCancellationProviderFactory struct {
	client runtimectx.Client
}

func (f roomCancellationProviderFactory) New(
	agentclient.Options,
) runtimectx.Client {
	return f.client
}
...
func TestExecutionCancellationUsesProviderForExactSoleRoomSlot(t *testing.T) {
	...
	client := &roomCancellationProviderClient{}
	factory := roomCancellationProviderFactory{client: client}
