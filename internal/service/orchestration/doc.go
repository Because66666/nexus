...
//   - context.go：面向当前 actor 的有界 <nexus_execution_context>、current input/output、已验收依赖、terminal subagent result ref、恢复/guarded replan、objective transition affordance 与 readiness 投影。
