...
//   - objective_transition.go / execution_binding.go / execution_completion.go / room_metadata.go / room_collaboration.go / room_completion.go / tool.go / retarget.go / event.go / cleanup.go / helpers.go：durable Goal objective revision / Execution rebase saga、Goal 反向 Execution binding、WorkGraph 与 Room completion gate、Room creator/lead 权限、revision 安全的协作证据、模型工具状态更新与同 ID 目标替换、事件广播、关联 Goal 探测与清理、辅助。
