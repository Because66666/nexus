...
type goalAgentResolver interface {
...
func newGoalMCPBuilder(
	...
	return func(
		...
		if agents != nil && sctx.CurrentAgentID != "" {
			if record, err := agents.GetAgent(context.Background(), sctx.CurrentAgentID); err == nil && record != nil {
