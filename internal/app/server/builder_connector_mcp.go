...
func newConnectorMCPBuilder(svc connectormcpcontract.Service, agents *agent.Service) func(string, string, string) map[string]sdkmcp.SDKMCPServer {
...
func combinedMCPBuilder(builders ...func(string, string, string) map[string]sdkmcp.SDKMCPServer) func(string, string, string) map[string]sdkmcp.SDKMCPServer {
	return func(agentID, sessionKey, sourceContextType string) map[string]sdkmcp.SDKMCPServer {
