...
func TestRepairLegacyExecutionIdentityClaimSchemaRestoresMissingTable(t *testing.T) {
...
func TestRepairLegacyExecutionIdentityClaimSchemaSkipsPreExecutionDatabase(t *testing.T) {
