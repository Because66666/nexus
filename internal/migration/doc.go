...
//
// 暴露接口：RepairLegacyAgentDisabledSkillSchema、RepairLegacyPrivateSkillMigrationCollision、RepairLegacyExecutionIdentityClaimSchema、RunStateLayout、RunWorkspaceLayout、MergeSkippedStateLayoutDatabase、MergeSkippedStateLayoutUsers、RunDesktopStateRootRebase、RunWorkspaceFiles、RunRoomFiles、RunDesktopLegacyConversationDraftRepair、RunRuntimeIdentitySync、RepairDesktopProviderScope。
//
